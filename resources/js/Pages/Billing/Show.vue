<template>
    <app-layout>
                        ...
                        <div class="intro-y bg-white mt-5 lg:mt-0">
                                ...
                                <jet-dropdown align="right" width="60">
                                    ...
                                    <template #content>
                                        <div class="w-60 shadow-xl bg-white rounded">
                                            <jet-dropdown-link :href="route('billing.edit',invoice.id)">
                                                <font-awesome-icon icon="edit"/>
                                                Edit
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('billing.email',invoice.id)">
                                                <font-awesome-icon icon="envelope"/>
                                                Email Invoice
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('billing.pdf',invoice.id)">
                                                <font-awesome-icon icon="file-pdf"/>
                                                Download Pdf
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('billing.print',invoice.id)">
                                                <font-awesome-icon icon="print"/>
                                                Print Invoice
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('billing.reconcile.create',invoice.id)">
                            ...
                            <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                                ...
                                <div v-if="invoice.sponsor=='co_payer'">
                                    <div class="flex justify-between">
                                        ...
                                        <span v-if="invoice.claimed=='1'" class="text-green-400">Yes</span>
                                        <span v-if="invoice.claimed=='0'" class="text-green-400">No</span>
                                    </div>
                                    <div class="flex justify-between">
                            ...
                            <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                                <div class="flex justify-between">
                                    ...
                                    <span>{{ invoice.currency.name }}</span>
                                </div>
                                <div class="flex justify-between">
                            ...
                            <div class="p-5 border-t border-gray-200 dark:border-dark-5 flex">
                                <button v-if="invoice.co_payer_id!='' && invoice.claimed==0" @click="confirmClaim=true"
                                        type="button" class="btn btn-primary py-1 px-2">
                                    Claim
                                </button>
                                <a :href="route('billing.reconcile.create',invoice.id)" v-if="invoice.claimed==1"
                                   ...
                                   <span class="px-6 py-4 flex items-center">
                                    ...
                                    <td class="border-t w-px pr-2">
                                        <div class=" flex items-center space-x-2">
                                            <inertia-link :href="route('billing.payments.print', invoice_payment.id)"
                                            ...
                                            <inertia-link :href="route('billing.payments.edit', invoice_payment.id)"
                                                          tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                                Edit
                                            </inertia-link>
                                            <a href="#" @click="deleteInvoicePaymentAction(invoice_payment.id)"
        ...
        <jet-dialog-modal :show="confirmClaim" @close="confirmClaim = false">
            ...
            <template #content>
                <p>This we will add this invoice to a claim batch</p>
            </template>
...
export default {
    ...
    methods: {
        ...
        destroy() {
            ...
            window.location = route('billing.index')
        },
