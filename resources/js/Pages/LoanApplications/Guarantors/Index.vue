            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white">
                    <div class="flex justify-between">
                        ...
                        <inertia-link class="btn btn-blue" :href="route('loans.index',loan.id)">
                            <span>Back </span>
                        </inertia-link>
                    </div>
                    <div class="mt-4 relative overflow-x-auto">
                        <form @submit.prevent="submit" v-if="can('loans.guarantors.create')">
                            ...
                            <tr v-for="guarantor in guarantors.data" :key="guarantor.id"
                                ...
                                <td class="border-t">
                                    <inertia-link class="px-6 py-4 flex items-center focus:text-indigo-500"
                                                  :href="route('members.show', guarantor.member_id)"
                                ...
                                <td class="border-t w-px pr-2">
                                    <div class=" flex items-center space-x-2">
                                        <a href="#" v-if="can('loans.guarantors.destroy')"
                                           @click="deleteAction(guarantor.id)"
