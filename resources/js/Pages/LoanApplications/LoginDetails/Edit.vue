            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" :href="route('loans.files.index',loan.id)">
                            <span>Back </span>
                        </inertia-link>
                    </div>
                    <div class="mt-4">
...
export default {
    ...
    data() {
        return {
            ...
            pageTitle: "Edit Loan Login Details",
            pageDescription: "Edit Loan Login Details",
    ...
    methods: {
        submit() {
            this.form.put(this.route('loans.files.update', this.file.id), {})
        },
    },
}
</script>
