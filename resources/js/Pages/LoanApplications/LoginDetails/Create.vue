            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" :href="route('loans.login_details.index',loan.id)">
                            <span>Back </span>
                        </inertia-link>
                    </div>
                    <div class="mt-4">
...
const fetchUsers = async (query) => {
    ...
    const response = await fetch(
        route('users.search') + '?type=loan&s=' + query,
        {}
    );
...
export default {
    ...
    data() {
        return {
            ...
            pageTitle: "Create Loan Login Details",
            pageDescription: "Create Loan Login Details",
    ...
    methods: {
        submit() {
            this.form.post(this.route('loans.login_details.store', this.loan.id), {})
        },
    },
}
</script>
