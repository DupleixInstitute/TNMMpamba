            ...
            <div class="flex items-start">
                ...
                <div class="w-9/12 ml-2 bg-white p-5">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" :href="route('loans.copayers.index',loan.id)">
                            <span>Back </span>
                        </inertia-link>
                    </div>
                    <div class="mt-4">
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Manage Loan Invoices",
    ...
    methods: {
        submit() {
            this.form.put(this.route('loans.invoices.update', this.invoice.id), {})
        },
        addService() {
