                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="mt-4 relative overflow-x-auto">
                        <table class="w-full whitespace-no-wrap table-auto">
                            ...
                            <tr>
                                <td class="border-t">
                                    <span class="px-6 py-4 flex items-center">Loan</span>
                                </td>
                                <td class="border-t">
                                    <span
                    ...
                    <div class="flex justify-between mt-2 ">
                        ...
                        <inertia-link class="btn btn-blue" v-if="can('billing.invoices.create')"
                                      :href="route('loans.invoices.create',loan.id)">
                            <span>Create </span>
...
export default {
    ...
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('loans.invoices.destroy', this.selectedRecord))
