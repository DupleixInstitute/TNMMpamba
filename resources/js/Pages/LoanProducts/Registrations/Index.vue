            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" v-if="can('courses.registrations.create')" :href="route('registrations.create',{course_id:course.id})">
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Course Registrations",
