...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                external_link: this.material.external_link,
                position: this.material.position,
            ...
            pageTitle: "Edit Course Material",
            pageDescription: "Edit Course Material",
    ...
    methods: {
        submit() {
            this.form.post(this.route('courses.materials.update', this.material.id), {})
        },
    },
}
</script>
