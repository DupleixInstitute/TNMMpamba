    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                industry_type_id: this.client.industry_type_id,
                registration_country_id: this.client.registration_country_id,
                main_bank_id: this.client.main_bank_id,
                second_bank_id: this.client.second_bank_id,
                third_bank_id: this.client.third_bank_id,
                registration_year: this.client.registration_year,
                years_in_business: this.client.years_in_business,
                registration_number: this.client.registration_number,
                legal_type_id: this.client.legal_type_id,
                trading_name: this.client.trading_name,
                audit_status: this.client.audit_status,
                real_annual_inflation_rate: this.client.real_annual_inflation_rate,
                nominal_annual_inflation_rate: this.client.nominal_annual_inflation_rate,
                years_at_present_address: this.client.years_at_present_address,
                tel: this.client.tel,
                zip: this.client.zip,
