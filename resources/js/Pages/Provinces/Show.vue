    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('locations.provinces.index')">
                    Provinces
                </inertia-link>
                <span class="text-indigo-400 font-medium">/</span> Province #{{ province.id }}
            </h2>
        </template>
