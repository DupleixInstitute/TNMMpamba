            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="w-full whitespace-no-wrap table-auto">
                    ...
                    <tr v-for="registration in registrations.data" :key="registration.id"
                        ...
                        <td class="border-t">
                            <inertia-link class="px-6 py-4 flex items-center" :href="route('portal.registrations.show', registration.id)"
                                          tabindex="-1">
                                {{ registration.id }}
                            </inertia-link>
                        </td>
                        <td class="border-t">
                            <inertia-link class="px-6 py-4 flex items-center" :href="route('portal.courses.show', registration.course_id)"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center gap-4">
                                <inertia-link :href="route('portal.registrations.show', registration.id)"
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('portal.registrations.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
