                ...
                <div class="w-80 mt-2 px-4 py-6 shadow-xl bg-white rounded">
                    <div class="mb-2">
                        ...
                        <select v-model="form.paid_by"
                            ...
                            <option :value="null"/>
                            <option value="member">Cash</option>
                    ...
                    <tr v-for="invoicePayment in invoicePayments.data" :key="invoicePayment.id"
                        ...
                        <td class="border-t">
                            <span class="px-6 py-4 flex items-center">
                                 <inertia-link :href="route('portal.payments.show', invoicePayment.id)"
                        ...
                        <td class="border-t">
                             <span class="px-6 py-4 flex items-center" v-if="invoicePayment.paid_by==='member'">
                                 Member
                            </span>
                        ...
                        <td class="border-t">
                           <span class="px-6 py-4 flex items-center" v-if="invoicePayment.payment_type">
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link
                                              :href="route('portal.payments.show', invoicePayment.id)"
                                              tabindex="-1" class="text-indigo-600 hover:text-indigo-900">
                                    View
                                </inertia-link>
                            </div>
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('portal.payments.index', Object.keys(query).length ? query : {}))
            }, 1000),
            deep: true,
        },
    },
