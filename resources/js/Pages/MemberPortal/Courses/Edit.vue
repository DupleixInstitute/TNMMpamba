    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                excerpt: this.course.excerpt,
                description: this.course.description ,
                allow_comments: this.course.allow_comments,
            ...
            usersMultiSelect: {
                ...
                searchable: true,
                options: async (query) => {
                    return await fetchUsers(query||this.course.staff_id)
                }
            },
            editorConfig: {
                ...
                toolbar: 'styleselect | bold italic | format alignleft aligncenter alignright alignjustify | bullist numlist  table paste | anchor charmap pagebreak link image media insertdatetime code codesample emoticons save preview  fullscreen',
            ...
            pageDescription: "Edit Course",
        }

    },
    methods: {
        submit() {
            this.form.post(this.route('courses.update', this.course.id), {})
        },
