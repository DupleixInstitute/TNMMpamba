        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <div>
                <inertia-link  class="btn btn-blue"
                              :href="route('portal.events.calendar')">
            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr v-for="event in events.data" :key="event.id"
                        ...
                        <td class="border-t w-px pr-2">
                            <div class=" flex items-center space-x-2">
                                <inertia-link
                                              :href="route('portal.events.show', event.id)"
                    ...
                    <tr v-if="events.data.length === 0">
                        <td class="border-t px-6 py-4 text-center" colspan="6">No Events found.</td>
                    </tr>
                    </tbody>
                </table>
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('portal.events.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
