            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white">
                    <div class="flex justify-between ">
                        ...
                        <inertia-link class="btn btn-blue" :href="route('portal.loans.notes.index',loan.id)">
                            <span>Back </span>
                        </inertia-link>
                    </div>
                    <div class="mt-4">
...
export default {
    ...
    data() {
        return {
            ...
            pageTitle: "Create Loan Notes",
            pageDescription: "Create Loan Notes",
    ...
    methods: {
        submit() {
            this.form.post(this.route('portal.loans.notes.store', this.loan.id), {})
        },
    },
}
</script>
