...
class RegionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        activity()
            ...
            ->log('Create Province');
        return redirect()->route('locations.regions.index')->with('success', 'Region created successfully.');
    }
    ...
    public function update(Request $request, Province $province)
    {
        ...
        activity()
            ->performedOn($province)
            ->log('Update Region');
        return redirect()->route('locations.regions.index')->with('success', 'Region updated successfully.');
    }
    ...
    public function destroy(Province $province)
    {
        ...
        activity()
            ->performedOn($province)
            ->log('Delete Region');
        return redirect()->route('locations.regions.index')->with('success', 'Region deleted successfully.');
    }
}
