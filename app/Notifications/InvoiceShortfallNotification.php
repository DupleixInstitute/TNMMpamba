...
class InvoiceShortfallNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $template = CommunicationTemplate::where('system_name', 'invoice_shortfall_email_template')->first();
