...
class InventoryProductSaleReturnDeletedUpdateStock  implements ShouldQueue
{
    /**
     ...
     * Handle the event.
     *
     * @param  \App\Events\InventoryProductSaleReturnDeleted  $event
     * @return void
     */
    public function handle(InventoryProductSaleReturnDeleted $event)
    {
