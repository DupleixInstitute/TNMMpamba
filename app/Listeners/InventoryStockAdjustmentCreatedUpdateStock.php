...
class InventoryStockAdjustmentCreatedUpdateStock  implements ShouldQueue
{
    /**
     ...
     * Handle the event.
     *
     * @param \App\Events\InventoryStockAdjustmentCreated $event
     * @return void
     */
    public function handle(InventoryStockAdjustmentCreated $event)
    {
