...
$email=NULL;
$loan_instalment1 = NULL;
$loan_instalment2 = NULL;
$loan_instalment3 = NULL;
$loan_instalment4 = NULL;
...
$day			= date('d',strtotime($_POST['borrower_birth']));
$month			= date('m',strtotime($_POST['borrower_birth']));
$year			= date('Y',strtotime($_POST['borrower_birth']));
//Spouse's date of birth===================================================================
if (isset($_POST['spouse_birth'])) {
	$day2		= date('d',strtotime($_POST['spouse_birth']));
	$month2		= date('m',strtotime($_POST['spouse_birth']));
	$year2		= date('Y',strtotime($_POST['spouse_birth']));
}
//Wedding date==============================================================================
if (isset($_POST['wedding'])) {
	$day22		= date('d',strtotime($_POST['wedding']));
	$month22    = date('m',strtotime($_POST['wedding']));
	$year22		= date('Y',strtotime($_POST['wedding']));
}

//Divorce date===============================================================================
if (isset($_POST['divorce'])) {
	$day23		= date('d',strtotime($_POST['divorce']));
	$month23	= date('m',strtotime($_POST['divorce']));
	$year23		= date('Y',strtotime($_POST['divorce']));
}
...
$loan_instalment1=$ainstallment1;
$loan_instalment2=$ainstallment2;
}

if ($numloans==3)
{
//echo "chose 3";
$debtserviceratio=(($binstallment1 + $binstallment2 + $binstallment3 + $loanandinsurance )/ $rev4afford )*100;
$loan_instalment1=$binstallment1;
$loan_instalment2=$binstallment2;
$loan_instalment3=$binstallment3;
}
if ($numloans==4)
{
//echo "chose 4";
$debtserviceratio=(($cinstallment1 + $cinstallment2 + $cinstallment3 + $cinstallment4 + $loanandinsurance )/ $rev4afford )*100;
$loan_instalment1=$cinstallment1;
$loan_instalment2=$cinstallment2;
$loan_instalment3=$cinstallment3;
$loan_instalment4=$cinstallment4;
}
if ($numloans==5)
{
//echo "chose 4";
$debtserviceratio=(($dinstallment1 + $dinstallment2 + $dinstallment3 + $dinstallment4 + $dinstallment5 + $loanandinsurance )/ $rev4afford )*100;
$loan_instalment1=$dinstallment1;
$loan_instalment2=$dinstallment2;
$loan_instalment3=$dinstallment3;
$loan_instalment4=$dinstallment4;
$loan_instalment5=$dinstallment5;
}
if ($numloans==6)
{
//echo "chose 4";
...
$loan_instalment1=$einstallment1;
$loan_instalment2=$einstallment2;
$loan_instalment3=$einstallment3;
$loan_instalment4=$einstallment4;
$loan_instalment5=$einstallment5;
$loan_instalment6=$einstallment6;
}
if ($numloans==7)
{
//echo "chose 4";
...
$loan_instalment1=$finstallment1;
$loan_instalment2=$finstallment2;
$loan_instalment3=$finstallment3;
$loan_instalment4=$finstallment4;
$loan_instalment5=$finstallment5;
$loan_instalment6=$finstallment6;
$loan_instalment7=$finstallment7;
}
if ($numloans==8)
{
//echo "chose 4";
...
$loan_instalment1=$ginstallment1;
$loan_instalment2=$ginstallment2;
$loan_instalment3=$ginstallment3;
$loan_instalment4=$ginstallment4;
$loan_instalment5=$ginstallment5;
$loan_instalment6=$ginstallment6;
$loan_instalment7=$ginstallment7;
$loan_instalment8=$ginstallment8;
}
if ($numloans==9)
{
//echo "chose 4";
...
$loan_instalment1=$hinstallment1;
$loan_instalment2=$hinstallment2;
$loan_instalment3=$hinstallment3;
$loan_instalment4=$hinstallment4;
$loan_instalment5=$hinstallment5;
$loan_instalment6=$hinstallment6;
$loan_instalment7=$hinstallment7;
$loan_instalment8=$hinstallment8;
$loan_instalment9=$hinstallment9;
}
  ...
  <td colspan="6" class="s_text"> <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <tr> 
        <td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT 
          REPORT - Unsecured Personal Loan</font></td>
      <tr> </tr>
      <tr> </tr>
      <tr> </tr>
      <tr> </tr>
      ...
      <tr> </tr>
      <tr> </tr>
      <form ACTION="report_unsecured_loan_original.php" method="post" name="f1">
...
//-------------------------------CONTRACTUAL YEARS REMAINING----------------------------------------------

switch($contractual_years_remaining){
case "0 to 1":
       $contractual_years_remaining_score=0;
		break;
case "1 to 2":
      $contractual_years_remaining_score =0;
		break;
...
$w_contractual_years_remaining_score=$contractual_years_remaining_score*0.02;
...
switch($loan_maturity)
 {
case ($loan_maturity > 0 and $loan_maturity < 3);
$loan_maturity_score =2000;
break;
case ($loan_maturity > 2 and $loan_maturity < 5);
$loan_maturity_score =1500;
break;
case ($loan_maturity > 4);
$loan_maturity_score =1250;
...
$total_personal_data			=	$marital_status_score 		+ 
									...
									$employment_score 			+ 
									$years_at_job_score 		+ 
									$contractual_years_remaining_score+
									$revenues_score 			+ 
									$location_score;

$w_total_personal_data			=	$w_marital_status_score 	+ 
									$w_age_score 				+ 
									...
									$w_contractual_years_remaining_score+
									$w_revenues_score 			+ 
									$w_location_score;
...
?>
	...
	echo "<td bgcolor=\"#32C079\">OK</td>"; ?>
         ...
         <tr align="center"> 
            ...
            <td><?php echo $dsr_score;?></td>
            <td><?php echo $dsr_w_score;?></td>
            <?php if ($dsr_comment=="REJECT")
	echo "<td bgcolor=\"#F20000\"> REJECT </td>";
	else
	echo "<td bgcolor=\"#32C079\">OK</td>"; ?>
          ...
          <tr align="center" bgcolor="#60BAF0" class="ntext"> 
            ...
            <td>1</td>
			<td></td>
            <td><?php echo $deduct_score;?></td>
            <td><?php echo $w_deduct_score;?></td>
            <td>&nbsp;</td>
            <td>0</td>
            <td>4</td>
          </tr>
...
$sql3	=	"INSERT INTO cust_information (
				omang_passport_num,
				CIF,
				loan_number,
			...
			ON DUPLICATE KEY UPDATE
				...
				contractual_years_remaining     = '$contractual_years_remaining',
				...
				tax                             = '$tax',
				loan_instalment1                = '$loan_instalment1',
				loan_instalment2                = '$loan_instalment2',
				loan_instalment3                = '$loan_instalment3',
				loan_instalment4                = '$loan_instalment4',
				loan_instalment5                = '$loan_instalment5',
				loan_instalment6                = '$loan_instalment6',
				loan_instalment7                = '$loan_instalment7',
