...
$sql1="select count(*) as count,cust_information.rate_type_requested as rate from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and approvals.status='approved' and cast(approvals.date as date)=$year$month$day group by cust_information.rate_type_requested;";
}

if (isset($day2)) {

$sql1="select count(*) as count,cust_information.rate_type_requested as rate from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and approvals.status='approved' and cast(approvals.date as date)=$year2$month2$day2 group by cust_information.rate_type_requested;";
}


if(isset($day) && isset($day2))
{
$sql1="select count(*) as count,cust_information.rate_type_requested as rate from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and approvals.status='approved' and cast(approvals.date as date) between $year$month$day and $year2$month2$day2 group by cust_information.rate_type_requested;";

}

if(empty($day) && empty($day2)){ 
$sql1="select count(*) as count,cust_information.rate_type_requested as rate from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and approvals.status='approved' group by cust_information.rate_type_requested;";
}
