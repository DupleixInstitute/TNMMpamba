...
$insert="SELECT * FROM cust_information where omang_passport_num='$omang_passport_num'";
...
<SELECT NAME="loan_type" onchange="displaya(this,'77', '78', '79');" disabled>
...
<td class="field"><SELECT NAME="o_loan_type" disabled>
<option value="">"<?php echo $rows['loan_type']; ?> </option>
...
<input name="loan_amount" type="text" onchange="return instal()" onFocus="this.blur" value="<?php echo $rows['loan_amount_requested']; ?>" disabled>
</td></tr>

<tr><td>Property Type:</td><td width="60">&nbsp;</td><td><SELECT NAME="property_type"  disabled>
<option value="">"<?php echo $rows['open_market_value']; ?></option>
...
<tr><td>Loan Maturity Requested</td><td width="60"></td><td><SELECT NAME="loan_maturity" onchange="return instal()" disabled>
<option value=""><?php echo $rows['loan_maturity_requested']; ?></option>
...
<tr><td>Rate Type Requested:</td><td width="60">&nbsp;</td><td><SELECT NAME="rate_type" disabled >
<option value=""><?php echo $rows['rate_type_requested']; ?></option>
<option value="Fixed">Fixed </option>
<option value="Floating">Floating</option>
<option value="Variable">Variable</option>
</SELECT></td>
<tr><td>Estimated Loan Current (Offered) Interest Rate pa</td><td width="60">&nbsp;</td><td>
<input name="irate" disabled type="text" onchange="return instal()" value="<?php echo $rows['current_interest_rate']; ?>">
</td></tr>
 
<tr><td>Insurance Replacement Cost</td><td width="60">&nbsp;</td><td>
<input name="insurance_replacement" type="text" value="<?php echo $rows['insurance_replacement_cost']; ?>" disabled>
</td></tr>
...
<tr>
                ...
                <td width="60">&nbsp;</td><td>
<input name="insurance_premium" type="text"  readonly="true" onFocus="premium()" value="<?php echo $rows['estimated_insurance_premium']; ?>" disabled>
</td></tr>

<tr><td>Estimated Instalment of the requested Loan <strong><font color="#FF0000">**</font></strong></td><td width="60">&nbsp;</td><td>
<input name="loan_installment" type="text"  readonly="true" onFocus="this.blur();" value="<?php echo $rows['estimated_installment']; ?>" disabled>
</td></tr>

<tr><td>Estimated Instalment + Insurance Premium  <strong><font color="#FF0000">**</font></strong></td><td width="60">&nbsp;</td><td>
<input name="loanandinsurance" type="text"  readonly="true" onClick="mortinstal()" value="<?php echo $rows['estimated_installment_insurance']; ?>" disabled>
</td></tr>


<tr><td>Loan To Value Policy <strong><font color="#FF0000">**</font></strong></td><td width="60">&nbsp;</td><td>
<input name="ltv_policy" type="text" readonly="true" onClick="myltvpolicy()" value="<?php echo $rows['loan_to_value_policy']; ?>" disabled>
</td></tr>

<tr><td>Loan To Value <strong><font color="#FF0000">**</font></strong> </td><td width="60">&nbsp;</td><td>
<input name="ltv" type="text" onClick="loantoval()" readonly="true" value="<?php echo $rows['loan_to_value']; ?>" disabled>
</td></tr>
...
<tr><td>Annual Salary Amount (Gross): </td><td width="60"></td><td><input type="text" name="annual_sal" onchange="return calcTotal()" value="<?php echo $rows['annual_salary']; ?>" disabled></td></tr>

<tr><td>Other Income:</td><td width="60"></td><td> <input type="text" name="fixed_perm_allowances" onchange="return calcTotal()" value="<?php echo $rows['fixed_permanent_allowances']; ?>" disabled></td></tr>
...
<tr><td>Household Partner- Annual Salary Amount (Gross): </td><td width="60"></td><td><input type="text" name="hp_annual_sal" onchange="return calcTotal()" value="<?php echo $rows['partner_annual_salary']; ?>" disabled></td></tr>

<tr><td>Household Partner- Other Income:</td><td width="60"></td><td> <input type="text" name="hp_fixed_perm_allowances" onchange="return calcTotal()" value="<?php echo $rows['partner_permanent_allowances']; ?>" disabled></td></tr>
...
<tr><td>Household Partner- Total Revenues for affordability: <strong><font color="#FF0000">**</font></strong> </td><td width="60"></td><td><input type="text" name="hp_total_rev_for_afford" onFocus="this.blur();" value="<?php echo $rows['partner_revenue_for_affordability']; ?>" disabled></td></tr>

<tr><td>TOTAL Allowable Household Revenues: <strong><font color="#FF0000">**</font></strong> </td><td width="10"></td><td><input type="text" name="total_allowable_household_revenues" value="<?php echo $rows['total_allowable_household_revenues']; ?>" disabled></td></tr>



<tr><td>Total revenues for affordability <strong><font color="#FF0000">**</font></strong> </td><td width="60">&nbsp;</td><td>
<input name="rev4afford"  readonly="true" type="text" value"<?php echo $rows['total_revenue_for_affordability'];?>" disabled>
</td></tr>


<tr><td>Affordability Policy</td><td width="60">&nbsp;</td><td>
<SELECT NAME="affordability_policy" disabled>
...
<input name="affordability_ratio" type="text" readonly="true" onClick="Affordability_Ratio()" disabled>
</td></tr>

<tr><td></td><td width="60">&nbsp;</td><td></td></tr>
<tr><td></td><td width="60">&nbsp;</td><td></td></tr>

<tr><td>Customer Type:</td><td width="60">&nbsp;</td><td><SELECT NAME="customer_type" disabled>
<option value=""><?php echo $rows['cutomer_type']; ?> </option>
<option value="Legal Entity">Legal Entity </option>
<option value="Physical">Physical</option>
</SELECT></td>
</tr>
<tr><td>Borrower Name :</td><td width="60">&nbsp;</td><td>
<input name="name" type="text" value="<?php echo $rows['borrower_name']; ?>" disabled>
</td></tr>
<tr><td>Nationality:</td><td width="60">&nbsp;</td><td>
  <SELECT NAME="nationality" disabled>
 <option value=""><?php echo $rows['nationality']; ?></option> 
...
<input name="other_name" type="text" value="<?php echo $rows['other_names']; ?>" disabled>
</td></tr>

<tr><td>Surname :</td><td width="60">&nbsp;</td><td>
<input name="surname" type="text" value="<?php echo $rows['surname']; ?>" disabled>
</td></tr>

<tr><td>Spouse,Partner,Co-Borrower Name :</td><td width="60">&nbsp;</td><td>
<input name="spouse_name" type="text" value="<?php echo $rows['spouse_partner_co_borrower_name']; ?>" disabled>
</td></tr>

<tr><td>Spouse Surname:</td><td width="60">&nbsp;</td><td>
<input name="spouse_surname" type="text" value=" <?php echo $rows['spouse_surname']; ?>" disabled>
</td></tr>

<tr><td>Borrower Present Address :</td><td width="60">&nbsp;</td><td>
<input name="address" type="text" value="<?php echo $rows['borrower_present_address']; ?>" disabled>
</td></tr>

<tr><td>Street Name and Number :</td><td width="60">&nbsp;</td><td>
<input name="street_add" type="text" value="<?php echo $rows['Street_name_and_number']; ?>" disabled>
</td></tr><?php
...
$query2 = "SELECT * FROM town order by town asc" ;
	...
	echo'<select name="town" disabled>';
...
?></td>
<td><input disabled type="text" value="<?php echo $rows['town']; ?>" disabled></td>
</tr> &nbsp;&nbsp;&nbsp;
<tr><td>Country:</td><td width="60">&nbsp;</td><td>
<input name="country" type="text" value="<?php echo $rows['country']; ?>" disabled>
</td></tr>

<tr><td>Permanent Country of Residence :</td><td width="60">&nbsp;</td><td><SELECT name="permanent_residence" disabled>
<option value=""><?php echo $rows['permanent_country_of_residence']; ?></option>
...
<tr><td>Location of Acquired REal Estate:</td><td width="60">&nbsp;</td><td> <SELECT NAME="location" disabled>
<option value=""><?php echo $rows['location_of_acquired_real_estate']; ?></option>
...
<tr><td>Marital Status</td><td width="60"></td><td> <SELECT NAME="marital_status" onclick="setReadOnly(this, 'Single')" disabled> 
<option value=""><?php echo $rows['marital_status']; ?></option>
...
<tr><td>Marital Contract Type</td><td width="60"></td><td> <SELECT NAME="marital_contract_type" disabled>
...
<tr><td>Spouse/Partner Borrowing Relationship</td><td width="60"></td><td> <SELECT NAME="spouse_borrowing_relationship" disabled>
<option value="Co-borrower/Guanrator">Co-borrower/Guanrator</option>
<option value="Other">Other </option>
<option value="na">na</option>

</SELECT></td>
<td><input disabled type="text" value="<?php echo $rows['spouse_borrowing_relationship']; ?>" disabled></td>
</tr>
...
<tr>
   <td><font color="#000066"><strong>Total Number of Children:<strong><font color="#FF0000">**</font></strong></strong></font></td>
                <td width="60"></td><td> <input type="text" name="no_of_children" value=0 onFocus="this.blur();" readonly="true" disabled> </td></tr>

<tr><td>Children living at home 0 to 12 years of age
 </td><td width="60"></td><td><SELECT NAME="to12" onChange="return total_kids()" disabled>
...
<tr><td>Children living at home 13 to 18 years of age</td><td width="60"></td><td><SELECT NAME="to18" onChange="return total_kids()" disabled>
...
<tr><td>Children living at home 19 to 26 years of age</td><td width="60"></td><td><SELECT NAME="to26" onChange="return total_kids()" disabled>
...
<tr><td>Other dependants Living in Household GrandParents</td><td width="60"></td><td><SELECT NAME="grandparents" onChange="return total_dependents()" disabled>
...
<tr><td>
Other dependants Living in Household Aunts/Uncles/Cousins</td><td width="60"></td><td><SELECT NAME="aunts_uncles_cousins" onChange="return total_dependents()" disabled>
<option value="0"><?php echo $rows['other_dependents_aunts']; ?></option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
...
<tr><td>Other dependants Living in Household</td><td width="60"></td><td><SELECT NAME="other" onChange="return total_dependents()" disabled>
<option value="0"><?php echo $rows['other_dependents']; ?></option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
...
Living at home:<strong><font color="#FF0000">**</font></strong></td>
 <td width="60"></td><td> <input disabled type="text" name="dependants_at_home" value=0 onFocus="this.blur();" readonly="true" > </td></tr>


<tr><td>Years At Present Address:</td><td width="60"></td><td> <SELECT NAME="years_at_address" disabled>
<option value=""><?php echo $rows['years_at_present_address']; ?></option>
...
<tr><td>Monthly payment (rental/instalment):</td><td width="60"></td><td> <input type="text" name="rent" value="<?php echo $rows['monthly_payment']; ?>" disabled> </td></tr>



<tr><td>Borrower Education:</td><td width="60"></td><td> <SELECT NAME="education" disabled>
<option value=""><?php echo $rows['borrower_education']; ?></option>
...
<tr><td>Professional Category:</td><td width="60"></td><td> <SELECT NAME="Professional" disabled>
<option value=""> <?php echo $rows['professional_category']; ?></option>
...
<tr><td>Employment Contract:</td><td width="60"></td><td> <SELECT NAME="employment" disabled>
<option value=""> <?php echo $rows['employment_contract']; ?>"</option>
...
<tr><td>Number Of Years Working at Present Employer:</td><td width="60"></td><td> <SELECT NAME="years_at_job" disabled>
<option value=""><?php echo $rows['number_of_years_at_employer']; ?></option>
...
<tr><td>Household Professional Revenues:</td><td width="60"></td><td> <SELECT NAME="revenues" onchange="return double()" disabled>
<option value=""><?php echo $rows['household_proffessional_revenue']; ?></option>
<option value="Single">Single</option>
...
<tr><td>Main Bank:</td><td width="10"></td><td> <SELECT NAME="mainbank" disabled>
...
<tr><td>Second Bank: </td><td width="10"></td><td><SELECT NAME="secondbank" disabled>
...
<tr><td>Third Bank: </td><td width="10"></td><td><SELECT NAME="thirdbank" disabled>
...
<tr><td>Age Of Relationshp with BBS:</td><td width="10"></td><td> <SELECT NAME="relationship" disabled>
<option value="NA"><?php echo $rows['age_of_relationship']; ?></option>
...
<tr><td>Savings Account:</td><td width="10"></td><td> <SELECT NAME="Savings" disabled>
...
<tr><td>Deposit Account: </td><td width="10"></td><td><SELECT NAME="Deposit" disabled>
<option value="NA"><?php echo $rows['deposit_Account']; ?></option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
</SELECT></td>
...
<tr><td>Share Account: </td><td width="10"></td><td><SELECT NAME="Share" disabled>
<option value="NA"><?php echo $rows['share_Account']; ?></option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
</SELECT></td>
...
<tr><td>ST Loans: </td><td width="10"></td><td><SELECT NAME="ST" disabled>
<option value="NA"><?php echo $rows['ST_Loans']; ?></option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
</SELECT></td>
...
<tr><td>Mortgages: </td><td width="10"></td><td><SELECT NAME="Mortgages" disabled>
<option value="NA"><?php echo $rows['mortgages']; ?></option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
</SELECT></td>
...
<tr><td>TOTAL BBS Products: <strong><font color="#FF0000">**</font></strong> </td><td width="10"></td><td><input type="text" name="total_bbs_products" disabled></td></tr>

<tr><td >BBS arrears for over 30days in last 12mnths?</br> 
</td><td width="10"></td><td><SELECT NAME="loan_arrears" disabled>
<option value="0"><?php echo $rows['bbs_arreas_12months']; ?></option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
...
</td><td width="10"></td><td><SELECT NAME="renegotiate" disabled>
<option value=""><?php echo $rows['renegotiated']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
</td><td width="10"></td><td><SELECT NAME="why_renogotiation" disabled>
<option value="0"><?php echo $rows['why_renegotiated']; ?></option>
...
<SELECT NAME="cards_held" disabled>
<option value=""><?php echo $rows['no_of_credit_card']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>Card held since (in years) </td><td width="10"></td><td><SELECT NAME="card_held_since" disabled>
<option value=""><?php echo $rows['card_held_since']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>Number of loans presently outstanding </td><td width="10"></td><td><SELECT NAME="loans_outstanding" onchange="display(this,'1','2','3','4');" disabled>
<option value="0"><?php echo $rows['number_of_loans_outstanding']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<td class="field"><input type="text" name="installment1" size="8" maxlength="7" disabled/></td>
</tr>
</tbody>
...
<td class="field"><input type="text" name="ainstallment1" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 2 installment:</td>
<td class="field"><input type="text" name="ainstallment2" size="8" disabled/></td>
</tr>
...
<tr>
<td class="title">loan 1 installment:</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="binstallment1" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 2 installment 2:</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="binstallment2" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 3 installment :</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="binstallment3" size="8" maxlength="7" disabled/></td>
</tr>
</tbody>
...
<tr>
<td class="title">loan 1 installment:</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="cinstallment1" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 2 installment:</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="cinstallment2" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 3 installment</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="cinstallment3" size="8" disabled/></td>
</tr>
<tr>
<td class="title">loan 4 installment:</td>
<td class="field">&nbsp;&nbsp;&nbsp;<input type="text" name="cinstallment4" size="8" maxlength="7" disabled/></td>
</tr>
</tbody>
...
<tr><td>ITC REF NP.</td><td width="60">&nbsp;</td><td><input type="text" name="itc_ref" value="<?php echo $rows['ITC_REF']; ?>" disabled></td></tr>
<tr><td>ITC SUBJECT NUMBER</td><td width="60">&nbsp;</td><td><input type="text" name="itc_sub_no" value="<?php echo $rows['ITC_subject_no']; ?>" disabled></td></tr>

<tr><td>ITC REPORT -(Paid Debt) </td><td width="10"></td><td><SELECT NAME="paid_debts" disabled>
<option value="0"><?php echo $rows['paid_debt']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>ITC REPORT: Judgement </td><td width="10"></td><td><SELECT NAME="judgement" disabled>
<option value="0"><?php echo $rows['judgment']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>ITC REPORT: Default Data </td><td width="10"></td><td><SELECT NAME="default_data" disabled>
<option value="0"><?php echo $rows['default_data']; ?></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>ITC REPORT: Trace Alerts  </td><td width="10"></td><td><SELECT NAME="trace_alerts" disabled>
<option value="0"><?php echo $rows['trace_alerts']; ?>"></option>
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>BlackList Flag  </td><td width="10"></td><td><SELECT NAME="blacklisted" disabled>
<option value="No"><?php echo $rows['blacklist_flag']; ?>"</option>
...
<tr><td>Fraud Alerts  </td><td width="10"></td><td><SELECT NAME="fraud_alert" disabled>
<option value="No"><?php echo $rows['fraud_alerts']; ?></option>
<option value="No">No</option>
<option value="Yes">Yes</option>
</SELECT>
</td>
...
<tr><td>Deduction from source? </td><td width="10"></td><td><SELECT NAME="deduct" disabled>
<option value="No"><?php echo $rows['deduct']; ?></option>
<option value="No">No</option>
<option value="Yes">Yes</option>
</SELECT></td>
