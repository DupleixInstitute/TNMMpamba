...
<td class="field"><SELECT NAME="o_loan_type" onchange = "ReCalculateForm()" >
...
<input name="open_market_value" type="text" onChange="loantoval()">
</td></tr>
...
<input name="insurance_replacement" type="text" onchange="">
</td></tr>
...
<input name="loanandinsurance" type="text"  readonly="true" onFocus="mortinstal()" onchange="return calcTotal()">
</td></tr>


<tr><td>Loan To Value Policy <strong><font color="#FF0000">**</font></strong></td><td width="60">&nbsp;</td><td>
<input name="ltv_policy" type="text" readonly="true" onFocus="myltvpolicy()">
</td></tr>
...
<tr><td>Household Partner- Other Income (pa):</td><td width="60"></td><td> <input type="text" name="hp_fixed_perm_allowances" onchange="return calcTotal()"></td></tr>
...
<input name="rev4afford"  readonly="true" autocomplete = "on" type="text" >
</td></tr>
