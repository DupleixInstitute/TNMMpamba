...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING-Mortgage Loan</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="detailscore_mortgage.php" name="total_revenue_for_Affordability" method="POST"  onClick="return displ();" onsubmit="return check(this);">
...
<tr><td>Marital Contract Type</td><td width="60"></td>
<td> <input type = "text" NAME="marital_contract_type" readonly="YES" value="<?php echo $rows['marital_contract_type']; ?>"/></td>
</tr>
...
<tr><td>Children living at home 0 to 12 years of age
 </td><td width="60"></td><td><SELECT NAME="to12"  readonly>
