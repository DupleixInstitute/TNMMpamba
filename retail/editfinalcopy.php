...
$why_renegotiate=$_POST['why_renegotiation'];
...
if ($rev4afford==0)
{
die("Please use back button to re-enter customer salary details");
}
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="bdr" ><tr>
  <td colspan="6" class="s_text"> <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <tr> </tr>
      <tr> </tr>
      <form ACTION="reportedit.php" method="post" name="f1">
...
w_deduct_score='$w_deduct_score' WHERE  omang_passport_num='$omang_passport_num' and loan_number=$loan_number";
