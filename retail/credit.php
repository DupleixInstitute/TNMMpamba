...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="rate22.php" name="total_revenue_for_Affordability" method="post"  onClick="return displ();" onsubmit="return isEmpty(this);">
...
<input name="dsr" type="text" readonly="true" onClick="dsrpolicy()">
