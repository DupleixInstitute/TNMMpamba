...
function displ()
{
  if(document.total_revenue_for_Affordability.Savings.options[0].value == true) {
    return false
  }
  else {
document.total_revenue_for_Affordability.total_bbs_products.value=document.total_revenue_for_Affordability.Savings.options[document.total_revenue_for_Affordability.Savings.selectedIndex].value;
  }
  return true;
}
//-->
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">SOUR PROJECT</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
<p></br> 
<form ACTION="testing.php" name="total_revenue_for_Affordability" method="post" onClick="return displ();">
...
<input name="insurance replacement" type="text">
</td></tr>
...
Acceptable total revenues for affordability
