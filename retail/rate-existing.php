...
$score=$total_product + $total_personal + $total_ICT + $total_length + $total_personal;

$w_score=$w_total_product + $w_total_personal + $w_total_ICT + $w_total_length + $w_total_personal;
