...
<TITLE>CREDIT SCORING-Final Approval</TITLE>
...
$selectO="SELECT 
                cust_information.street_name_and_number  as street,
			    cust_information.debtserviceratio        as debt,
			    cust_information.bond_plot               as bond,
			    cust_information.loan_to_value           as ltv, 
			    cust_information.affordability_ratio     as aff,
			    cust_information.loan_amount_requested   as loan,
			    cust_information.current_interest_rate   as interest,
			    cust_information.loan_maturity_requested as maturity,
			    cust_information.estimated_installment   as installment,
			    cust_credit_rating.rate                  as rate 
		  FROM  cust_information,
		        creditscore,
			    cust_credit_rating 
		  WHERE cust_information.omang_passport_num = cust_credit_rating.omang_passport_num and 
		        cust_information.omang_passport_num = creditscore.omang_passport_num        and 
				cust_information.loan_number        = creditscore.loan_number               and 
				cust_information.loan_number        = cust_credit_rating.loan_number        and 
				cust_information.omang_passport_num = '$omang_passport_num'                 and 
				cust_information.loan_number        = $loan_number";

$result1=(mysqli_query($connect,$selectO));
if($result1)
{
  //echo "omand done".$omang_passport_num."sss".$loan_number;
}
...
if ($mycounts<1){
	...
	if ($rows1['rate'] == 4){
		$Action = "Decline";	
	}else if ($rows1['rate'] == 3){
		$Action = "Request More Documents/ Physical Enquiry";
	}else if ($rows1['rate'] == 2){
		$Action = "Review Application";
	}else if ($rows1['rate'] == 1){
		$Action = "Approve";
	}Else{
		$Action = NULL;
	}
...
<font color="#000040" face="Times New Roman, Times, serif"> </br>
ID NUMBER: <?php echo $omang_passport_num;?></br></br>
LOAN NUMBER: <?php echo $loan_number;?></br></br>

</font>
<tr bgcolor="#FFFFFF"><td width="40%"><?php echo "PLOT NUMBER: ";?></td><td width="20%"></td><td><?php echo $rows1['street']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "LTV: ";?></td><td width="20%"></td><td><?php echo $rows1['ltv']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "AFFORDABILITY RATIO:";?></td><td width="20%"></td><td><?php echo $rows1['aff']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "DEBT SERVICE RATIO:";?></td><td width="20%"></td><td><?php echo $rows1['debt']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "LOAN AMOUNT";?></td><td width="20%"></td><td><?php echo $rows1['loan']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "INTEREST RATE: ";?></td><td width="20%"></td><td><?php echo $rows1['interest']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "YEARS TO MATURITY: ";?></td><td width="20%"></td><td><?php echo $rows1['maturity']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "REPAYMENT AMOUNT: ";?></td><td width="20%"></td><td><?php echo $rows1['installment']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "BOND SECURITY PLOT No: ";?></td><td width="20%"></td><td><?php echo $rows1['bond']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "PD Rating: ";?></td><td width="20%"></td><td><?php echo $rows1['rate']."</BR>"."</BR>" ;?></td></tr>
<tr  bgcolor="#FFFFFF"><td width="40%"><?php echo "PD Action: ";?></td><td width="20%"></td><td><?php echo $Action."</BR>"."</BR>" ;?></td></tr>


</table>
</br></br>
<input type="hidden" name="omang2" value="<?php echo $omang_passport_num;?>" />
<input type="hidden" name="loan_number2" value="<?php echo $loan_number;?>" />
