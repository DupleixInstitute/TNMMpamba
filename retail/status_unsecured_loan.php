...
<tr>
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="6" face="Arial Narrow">CREDIT SCORING - RECOMMENDATION (Unsecured Loan)</font></td><tr>
      </tr>
<table>
...
} catch (Exception $e) { echo "There is this error ".$e->getMessage();}
...
echo "First  Level Approval Signature:  ______________________________________"."</BR>"."</BR>"."</BR>";

echo "Second Level Approval Signature:  ______________________________________"."</BR>"."</BR>"."</BR>";
