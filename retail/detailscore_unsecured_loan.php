...
$user ="root";
$password = $_POST['password'];//echo $username;echo 'mmm';
...
$perm_res=$_POST['permanent_residence'];
...
$debtserviceratio					=	$_POST['debtserviceratio'];
$deduct								=	$_POST['deduct'];
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="bdr" ><tr>
  <td colspan="6" class="s_text"> <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <tr> </tr>
      <tr> </tr>
      <form ACTION="approval_unsecured_loan.php" method="post" name="f1">
	...
	echo "<td bgcolor=\"#32C079\">OK</td>";?>
          ...
          <tr> 
            <td>Nationality: Botswana/ Foreign</td>
...
$score=$total_product + $total_personal +  $total_length + $total_personal_data+$total_ICT+$deduct_score;

$w_score=$w_total_product + $w_total_personal  + $w_total_length + $w_total_personal_data+$w_total_ICT+$w_deduct_score;
...
?>
         ...
         <td><?php echo $w_total_personal_data;?></td>
          ...
          <tr align="center"> 
            <td># of arrears incidence over the last 12 months</td>
           <!-- <td>10</td>-->
   ...
   <td>&nbsp;</td>
	   ...
	   <input type="hidden" name="omang" value="<?php echo $omang;?>"/>
