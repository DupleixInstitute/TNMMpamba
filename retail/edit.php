...
$sql1="SELECT * FROM cust_information where omang_passport_num='$omang_passport_num'";
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="editform.php" name="editform" method="POST">
            <td><table><tr><td><p align="justify" class="s_text"><br>
<table class="s_text" border="1">
<tr>
<td align="center" bgcolor="#FFFFFF">#</td>
<td align="center" bgcolor="#FFFFFF"><strong>omang</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>cif</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>Loan Amont Requested</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>loan type</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>borrower name</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>borrower surname</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>borrower present address</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>town</strong></td>
<td align="center" bgcolor="#FFFFFF"><strong>contry</strong></td>
<td align="center" bgcolor="#FFFFFF" width="40"><strong>Loaction of real estate</strong></td>
</tr>
<tr>
<td align="center" bgcolor="#FFFFFF"><input name="checkbox2[]" type="checkbox" id="checkbox2[]" value="<?php echo $rows['id']; ?>"></td>
<td bgcolor="#FFFFFF"><?php echo $rows['omang_passport_num']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['CIF']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['loan_amount_requested']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['loan_type']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['borrower_name']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['surname']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['borrower_present_address']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['town']; ?></td>
<td bgcolor="#FFFFFF"><?php echo $rows['country']; ?></td>
<td bgcolor="#FFFFFF" width="40"><?php echo $rows['location_of_acquired_real_estate']; ?></td>
...
<input type="hidden" name="omang1" value="<?php echo $omang_passport_num;?>" />

<input type="SUBMIT" name="edit"  class="btn" value="edit"/>  </td>
