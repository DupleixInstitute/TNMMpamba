...
if (isNaN(rate) || isNaN(amount) || isNaN(maturity)) {
		alert("You can only enter numbers in the Loan Amount and Rate fields!");	
}
...
var loan_category =document.total_revenue_for_Affordability.loan_category.value;
  ...
  //url field 
    ...
    {
       if (loan_category == 'mortgage') {    
	      alert("Please enter value for the property type.")
          return false;
	   }else {
          return true;       
	   }		   
...
{
   alert("Please enter value for professional category")  
   return false;
}
...
<table class="s_text">
   ...
   <tr>
        ...
        <td></td>
		<td>
		    <select type="text" name="loan_category" onchange = "menuphp_show_loan_category_icon(this.value);">
...
<tbody id = "open_market_value"  >
	<tr><td>Open Market Value:</td><td width="60">&nbsp;</td><td>
	       <input name="open_market_value" value = "0" type="text" onchange ="loantoval()" onfocus = "loantoval()">
	    </td>
	</tr>
</tbody>
<!-------------------------------------------------------------------------------------------------------------->	
...
<tbody id = "insurance_replacement">
   <tr>
	  ...
	  <td><input name="insurance_replacement" type="text" onchange = "premium()"></td>
   </tr>
</tbody>
<!--------------------------------------------------------------------------------------------->
...
<tbody id = "life_cover_amount" style = "display:none">
   <tr>
	  ...
	  <td><input name="life_cover_amount" type="text"></td>
   </tr>
</tbody>
<!--------------------------------------------------------------------------------------------->
<tr>
...
<tbody id = "loan_to_value">
	<tr>
	   ...
	   <td width="60">&nbsp;</td>
	   <td><input name="ltv_policy" type="text" readonly="true" onClick="myltvpolicy()"></td>
	</tr>
	<tr>
...
<tbody id = "household_partner_revenues">
	...
	<tr>
		 ...
		 <td width="60"></td><td> <input type="text" name="tax2" onchange="return calcTotal()"></td>
	</tr>
	<tr>
	     <td>Household Partner- Total Revenues for affordability: <strong><font color="#FF0000">**</font></strong> </td>
		 <td width="60"></td><td><input type="text" name="hp_total_rev_for_afford" onFocus="this.blur();"></td>
	</tr>
	<tr>
	     <td>TOTAL Allowable Household Revenues: <strong><font color="#FF0000">**</font></strong> </td>
		 <td width="10"></td><td><input type="text" name="total_allowable_household_revenues"></td>
	</tr>
</tbody>
...
<tr>
  <td>Other Names :</td>
  <td width="60">&nbsp;</td>
  <td><input name="other_name" type="text"></td>
</tr>
...
<tbody id = "bond_plot" >
  <tr>
      <td>Plot No.of bonded security :</td><td width="60">&nbsp;</td><td>
...
<tr>
   ...
   <td width="60">&nbsp;</td>
   <td><SELECT name="permanent_residence" >
