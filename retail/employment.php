...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
         <tr><td align="center"><font color="#000066" size="4" class="btn"><strong>EMPLOYMENT CONTRACT REPORT</strong></font></td></tr>

        <form ACTION="employment_approved.php" name="employment" method="POST">
        <tr><td>&nbsp;</td></td><tr> 
...
<tr><td>&nbsp;&nbsp;&nbsp;Date2:&nbsp;&nbsp; <input name="r2" type="checkbox" onclick="day22.disabled=true
