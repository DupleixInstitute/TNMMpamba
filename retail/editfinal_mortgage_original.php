...
<TITLE>CREDIT SCORING - Mortgage Loan Edit</TITLE>
...
$location=$_POST['location'];
	...
	$month2								= isset($_POST['month2'])?
	                                      $_POST['month2']:
										  date('m',strtotime($_POST['spouse_birth_date']));
	...
	$month22							= isset($_POST['month22'])?
	                                      $_POST['month22']:
										  date('m',strtotime($_POST['wedding_date']));
	...
	$month23							= isset($_POST['month23'])?
	                                      $_POST['month23']:
										  date('m',strtotime($_POST['divorce_date']));
...
$why_renegotiate= isset($_POST['why_renogotiation'])?$_POST['why_renogotiation']:null;
...
$number_of_dependants=isset($_POST['number_of_dependants'])?$_POST['number_of_dependants']:null;
  ...
  <td colspan="6" class="s_text"> <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <tr> 
        <td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT 
          REPORT - Mortgage Loan Edit</font></td>
      <tr> </tr>
      <tr> </tr>
      <tr> </tr>
      <tr> </tr>
...
dependants_at_home ='$dependants_at_home_score',
