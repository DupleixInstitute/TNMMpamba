...
<TITLE>CREDIT SCORING - Mortgage</TITLE>
...
//echo 't�yyyyyyyy'; echo $renegotiate;
...
switch($location){
case ($location=='Urban A');
       $location_score=400;
		break;
case ($location=='Urban B');
       $location_score=400;
		break;
...
$w_location_score=$location_score*0.03;
