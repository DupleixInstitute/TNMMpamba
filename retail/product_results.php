...
$sql1="SELECT 
             ...
             COUNT(*) as total_count
	   FROM  cust_information  
	   group by rate_type_requested order by total_count DESC;";
}
        ...
        <form name="editform" method="POST">
          <tr><td><p align="justify" class="s_text"><br>
            <table width="600" height="57" border="0" align="center" bordercolor="#000066" bgcolor="#000066"  class="s_text" >
              <tr> 
                  <td width="150" bgcolor="#000066" align="center"><strong><font color="#FFFFFF">RATE TYPE</font></strong></td>
...
?>
              <tr> 
                <td width="150" bgcolor="#FFFFFF" align="center"><?php echo $rows['rate'];?></td>
