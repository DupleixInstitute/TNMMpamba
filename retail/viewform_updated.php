...
var loan_category =document.total_revenue_for_Affordability.loan_category.value;
...
<table class="s_text">
   ...
   <!-- Addition------------------------------------------------------------------------------------------>
   <tr>
        <td><strong><font color="#000000">Retail Loan Category</font></strong></td>
        <td></td>
		<td>
		    <select type="text" 
			   value    = "<?php echo $_POST['loan_category'];?>" 
			   name     ="loan_category" 
			   onchange = "menuphp_show_loan_category_icon(this.value);">
  		       <option value = "mortgage" >mortgage</option>
		       <option value = "unsecured loan"    >unsecured loan</option>
			</select> 
		</td> 
		<td rowspan = 30>
		    <img src   ="assets/icons/mortgage_loan1.png" 
			     alt   ="nknk" 
				 id    ="loan_category_icon" 
				 name  ="loan_category_icon"
				 width ="150" 
				 height="100"/>
		</td>
   </tr>
   ...
   <tr>
        ...
        <td></td>
		<td><input type="text" name="cif" value="<?php echo $rows['CIF']; ?>" readonly></td> 
   </tr>
<tr><td>Loan Application Number</td><td width="60">&nbsp;</td><td>
<SELECT NAME="loan_number" value = "<?php echo $_POST['loan_number'];?>">
<option value=""> </option>
...
<SELECT NAME="loan_type" 
		onchange="displaya(this,'77', '78', '79');">
...
<input name="loan_amount" value = "<?php echo $_POST['loan_amount_requested'];?>"  
       type="text" onchange="return instal()" onFocus="this.blur">
</td></tr>

<!---------- inserted a tbody wiht same id as name to allow display toggling----------------------------------------------->
<tbody id = "property_type" value = "<?php echo $_POST['property_type'];?>" >
	<tr>
		<td>Property Type:</td><td width="60">&nbsp;</td>
		<td><SELECT NAME="property_type" onchange="return instal()">
...
<tbody id = "open_market_value"  >
	<tr><td>Open Market Value:</td><td width="60">&nbsp;</td><td>
	       <input name="open_market_value" value = "<?php echo $_POST['open_market_value'];?>" 
		          type="text" onchange ="loantoval()" onfocus = "loantoval()">
	    </td>
	</tr>
</tbody>
<!-------------------------------------------------------------------------------------------------------------->	
...
<tr><td>Loan Maturity Requested</td><td width="60"></td>
   <td>
<SELECT NAME="loan_maturity" onchange="return instal()">
...
<td><SELECT NAME="rate_type" value = "<?php echo $_POST['rate_type'];?>" >
...
<!--------------------------------------------------------------------------------------------->
<tbody id = "insurance_replacement">
   <tr>
      <td>Insurance Replacement Cost</td><td width="60">&nbsp;</td>
	  <td><input name="insurance_replacement" type="text" 
	             readonly
				 value = "<?php echo $_POST['insurance_replacement_cost'];?>" 
	             onchange = "premium()"></td>
   </tr>
</tbody>
<!--------------------------------------------------------------------------------------------->
...
<!--------------------------------------------------------------------------------------------->
<tbody id = "life_cover_amount" style = "display:none">
   <tr>
      <td>Life Cover Amount</td><td width="60">&nbsp;</td>
	  <td><input name="life_cover_amount" value = "<?php echo $_POST['life_cover_amount'];?>" 
...
<!------------------------------------------------------------------------------------------------------------------>
<tbody id = "loan_to_value">
	<tr>
	   <td>Loan To Value Policy<strong><font color="#FF0000">**</font></strong></td>
	   <td width="60">&nbsp;</td>
          <input name="ltv_policy" type="text" readonly="true" onClick="myltvpolicy()" value="<?php echo $rows['loan_to_value_policy']; ?>" readonly="YES">
	</tr>
	<tr>
	   <td>Loan To Value<strong><font color="#FF0000">**</font></strong></td>
	   <td width="60">&nbsp;</td>
...
<tr><td>Annual Salary Amount (Gross): </td><td width="60"></td>
<td><input type="text" name="annual_sal" 
           value = "<?php echo $_POST['annual_salary'];?>"
		   readonly
           onchange="return calcTotal()"></td></tr>

<tr><td>Other Income (pa):</td><td width="60"></td>
     <td> <input type="text" name="fixed_perm_allowances" 
	             value="<?php echo $rows['fixed_permanent_allowances']; ?>" 
				 readonly="YES"
				 onchange="return calcTotal()"></td></tr>

<tr><td>Tax (pa)</td><td width="60"></td>
     <td> <input type="text" name="tax" 
	             value = "<?php echo $_POST['tax'];?>"	             
				 onchange="return calcTotal()"></td></tr>
...
<!---------------------------------------------------------------------------------------------------------->
<tbody id = "household_partner_revenues">
	<tr>
	...
	<tr>
	    <td>Household Partner- Annual Salary Amount (Gross): </td>
		<td width="60"></td>
		<td><input type="text"       name="hp_annual_sal" onchange="return calcTotal()" 
		           value="<?php echo $rows['partner_annual_salary']; ?>" readonly="YES">
		</td>
	</tr>
	<tr>
	    <td>Household Partner- Other Income (pa):</td>
		<td width="60"></td>
		<td><input type="text" name="hp_fixed_perm_allowances" 
		           onchange="return calcTotal()"
		           value="<?php echo $rows['partner_permanent_allowances']; ?>" 
				   readonly="YES">
		</td>
	</tr>
	<tr>
	     <td>Household Partner- Tax (pa):</td>
		 <td width="60"></td>
		 <td><input type     = "text"    name="tax2" 
		            onchange = "return calcTotal()"
		            value="<?php echo $rows['tax2']; ?>">
		</td>
	</tr>
	<tr>
	     <td>Household Partner- Total Revenues for affordability: <strong><font color="#FF0000">**</font></strong> </td>
		 <td width="60"></td>
		 <td><input type="text" name="hp_total_rev_for_afford" 
		            value="<?php echo $rows['partner_revenue_for_affordability']; ?>" readonly="YES"
					onFocus="this.blur();"></td>
	</tr>
	<tr>
	     <td>TOTAL Allowable Household Revenues: <strong><font color="#FF0000">**</font></strong> </td>
		 <td width="10"></td>
		 <td><input type="text" 
		            value="<?php echo $rows['total_allowable_household_revenues']; ?>" readonly="YES"
					name="total_allowable_household_revenues">
		 </td>
	</tr>
</tbody>
...
<SELECT NAME="affordability_policy" readonly >
...
<tr><td>Customer Type:</td><td width="60">&nbsp;</td><td><SELECT NAME="customer_type" readonly > 
...
<tr>
   <td>Has Customer Provided Permanent Residency Permit?</td><td width="60">&nbsp;</td><td>
...
<tr>
  <td>Other Names :</td>
  <td width="60">&nbsp;</td>
  <td><input name="other_name" type="text" value="<?php echo $rows['other_names']; ?>" readonly="YES"></td>
</tr>
...
<option value="<?php echo $rows['surname']; ?>"><?php echo $rows['surname']; ?></option>
<option value="M">M</option>
<option value="F">F</option>
</SELECT></td></tr>

<!---------------------------------------------------------------------------------------------------------->
<tbody id = "spouse_names">	
	<tr>
	    <td>Spouse,Partner,Co-Borrower Name :</td>
		<td width="60">&nbsp;</td>
        <input name="spouse_name" type="text" value="<?php echo $rows['spouse_partner_co_borrower_name']; ?>" readonly="YES">
	</tr>
	<tr><td>Spouse Surname:</td>
	    <td width="60">&nbsp;</td>
...
<input name="address" type="text" value="<?php echo $rows['e_mail']; ?>" readonly="YES">
</td></tr>
<tr><td>Plot No.of bonded security :</td><td width="60">&nbsp;</td><td>
<input name="address" type="text" value="<?php echo $rows['bond_plot']; ?>" readonly="YES">
</td></tr>

<tr><td>Street Name and Number :</td><td width="60">&nbsp;</td><td>
<input name="address" type="text" value="<?php echo $rows['Street_name_and_number']; ?>" readonly="YES">
</td></tr>
...
<tr>
   ...
   <td width="60">&nbsp;</td>
   <td><SELECT name="permanent_residence" readonly = "YES" >
...
<tbody id = "location">	
	<tr>
	   <td>Location of Acquired Real Estate:</td>
	   <td width="60">&nbsp;</td>
	   <td> <SELECT NAME="location" reaodnly ="YES" >
...
<tr>
    <td>Marital Contract Type</td>
	<td width="60"></td>
	<td> <SELECT NAME="marital_contract_type" readonly="YES">
...
<!--------------------------------------------------------------------------------------------------------->
<tbody id = "spouse_borrowing_relationship">
	<tr>
	   <td>Spouse/Partner Borrowing Relationship</td>
	   <td width="60"></td>
	   <td> <SELECT NAME="spouse_borrowing_relationship" readonly>
...
<tr>
   ...
   <td width="60"></td>
   <td><input type="text" name="no_of_children" value=0 onFocus="this.blur();" readonly="true">
   </td>
</tr>
...
<tr>
   ...
   <td width="60"></td>
   <td><SELECT NAME="to12" onChange="return total_kids()" readonly>
...
<tr>
<td>Children living at home 19 to 26 years of age</td>
<td width="60"></td>
<td><SELECT NAME="to26" onChange="return total_kids()" readonly>
...
<td width="60"></td>
<td>
	<SELECT NAME="grandparents" onChange="return total_dependents()" readonly>
...
<tr><td>
Other dependants Living in Household Aunts/Uncles/Cousins</td>
<td width="60"></td>
<td>
	<SELECT NAME="aunts_uncles_cousins" onChange="return total_dependents()" readonly >
...
<tr>
   ...
   <td><SELECT NAME="employment" id = "employment" onchange = "menuphp_toggle_contractual_years(this.value)" >
			<option value=""> </option>
...
<!--------------------------------------------------------------------------------------------------------->
<tbody id = "contractual_years_remaining" style = "display:none">
	<tr>
...
<tr><td>Savings Account:</td><td width="10"></td><td> <SELECT NAME="Savings" onchange = "displ()">
<option value="NA">NA</option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
...
<tr><td>Deposit Account: </td><td width="10"></td><td><SELECT NAME="Deposit" onchange = "displ()">
<option value="NA">NA</option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
...
<tr><td>Share Account: </td><td width="10"></td><td><SELECT NAME="Share" onchange = "displ()">
<option value="NA">NA</option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
...
<tr><td>ST Loans: </td><td width="10"></td><td><SELECT NAME="ST" onchange = "displ()">
<option value="NA">NA</option>
<option value="Since less than 1 year">Since less than 1 year</option>
<option value="Since 1 to 5 years">Since 1 to 5 years</option>
<option value="More than 5 years">More than 5 years</option>
...
<tr><td>TOTAL BBS Products: <strong><font color="#FF0000">**</font></strong> </td>
    <td width="10"></td><td><input type="number" readonly value = "0" name="total_bbs_products" onclick = "displ()"></td>
</tr>
...
<tr>
   <td>Card held since (in years)</td>
   <td width="10"></td>
