...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
            <tr><td align="center"><font color="#000066" size="4" class="btn"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CONSULTANT COUNTS</strong></font></td></tr>
      
        <form ACTION="ConsultantCount.php" name="returned" method="post">
...
<input name = "omang"    type = "hidden" value = "<?php echo $_POST['myid'];?>">  
