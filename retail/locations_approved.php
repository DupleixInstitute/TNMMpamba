...
if (isset($day)){
  $sql1="select count(*) as count,cust_information.location_of_acquired_real_estate as location,approvals.status as status from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and  approvals.status='approved' and cast(approvals.date as date)=$year$month$day group by cust_information.location_of_acquired_real_estate";
...
$sql1="select count(*) as count,cust_information.location_of_acquired_real_estate as location,approvals.status as status from cust_information,approvals where cust_information.omang_passport_num=approvals.omang and  approvals.status='approved' group by cust_information.location_of_acquired_real_estate";
}
