...
var strfield29= document.total_revenue_for_Affordability.professional.value;
var strfield30= document.total_revenue_for_Affordability.employment.value;
...
{ 
alert("Please enter value for other income.") 
   return false;
}
...
{
 alert("Please select value for gender")  
 return false;
}
if(strfield28 == "" || strfield28 == null)
{
 alert("Please select value for education")  
 return false;
}
if(strfield29 == "" || strfield29 == null)
{
 alert("Please select value for professional")  
 return false;
}
if(strfield30 == "" || strfield30 == null)
{
 alert("Please select value for employment")  
 return false;
}
    return true;
}
...
if (isEmpty(total_revenue_for_Affordability.gender)){
...
<tr><td>Plot No.of bonded security :</td><td width="60">&nbsp;</td><td>
<input name="plot_of_bond" type="text">
</td></tr>
<?php
