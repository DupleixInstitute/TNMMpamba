...
var total_dependents=children11 + children22 + children33 + aunts1 + others1 + grandparents1;
...
var insurance=document.total_revenue_for_Affordability.loanandinsurance.value;
var acceptable =document.total_revenue_for_Affordability.total_allowable_household_revenues.value;    


var ratio= (insurance * 12 )/acceptable;
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="rate.php" name="total_revenue_for_Affordability" method="post"  onClick="return displ();">
...
<input name="loan_amount" type="text" onchange="return instal()">
</td></tr>
...
<option value="Guranteed Scheme">Guranteed Scheme</option>
...
<input name="loanandinsurance" type="text"  readonly="true" onClick="mortinstal()" >
</td></tr>
...
<tr>
   <td><font color="#000066"><strong>Total Number of Children:</strong></font></td>
                <td width="60"></td><td> <input type="text" name="no_of_children"> </td></tr>

<tr><td>Children living at home 0 to 12 years of age
 </td><td width="60"></td><td><SELECT NAME="to12" onChange="return total_dependents()">
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>Children living at home 13 to 18 years of age</td><td width="60"></td><td><SELECT NAME="to18" onChange="return total_dependents()">
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr><td>Children living at home 19 to 26 years of age</td><td width="60"></td><td><SELECT NAME="to26" onChange="return total_dependents()">
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<tr>
                <td><font color="#000066"><strong>TOTAL</strong></font> Dependants 
                  Living at home:</td>
                <td width="60"></td><td> <input type="text" name="dependants_at_home" onFocus="this.blur();" readonly="true"> </td></tr>
...
<tr><td>Fraud Alerts  </td><td width="10"></td><td>
