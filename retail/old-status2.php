...
if (isset($reason))
{
$sql2="insert into approvals values ('$omang','$loan_number','$status1','$username','','$reason', NOW())";

}
if (isset($reason1))
{
$sql2="insert into approvals values ('$omang','$loan_number','$status1','$username','$reason1','', NOW())";
}
if (isset($reason1) && isset($reason))
{
$sql2="insert into approvals values ('$omang','$loan_number','$status1','$username','$reason1','$reason', NOW())";

}
if (empty($reason) && empty($reason1))
{
$sql2="insert into approvals() values ('$omang','$loan_number','$status1','$username','','', NOW())";
}
