...
<tr>
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING - Mortgage Loan Edit</font></td><tr>
      </tr>
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="editfinal_mortgage_original.php" name="total_revenue_for_Affordability" method="post"  onClick="return displ();" onsubmit="return check(this);">
...
<tr><td>Borrower Birthdate</td><td>&nbsp;</td>
<td><input  type="date" name = "borrower_birth_date" value="<?php echo $rows['borrower_birth']; ?>"></td>
<td><input disabled type="text" value="<?php echo $rows['borrower_birth']; ?>"></td>
</tr>

 <tr><td>
Spouse BirthDate: <input name="r3" type="checkbox" onclick="spouse_birth_date.disabled=true" 
onDblClick="spouse_birth_date.disabled=false" value=""/>n/a: </td><td width="60">&nbsp;</td>

<td>
    <input type="date" name = "spouse_birth_date" value="<?php echo $rows['spouse_birth']; ?>">
</td>
<td><input disabled type="text" value="<?php echo $rows['spouse_birth']; ?>"></td>
</tr>
</br>
<tr><td>Wedding Date:  <input name="r2" type="checkbox" onclick="wedding_date.disabled=true" 
onDblClick="wedding_date.disabled=false" value=""/>n/a:</td><td width="60">&nbsp;</td>
<td>
<input type="date" name ="wedding_date" value="<?php echo $rows['wedding']; ?>"></td>
</td>
...
<tr><td> 
Divorce Date <input name="r1" type="checkbox" onclick="divorce_date.disabled=true" onDblClick="divorce_date.disabled=false
divorce_date.disabled=false
divorce_date.disabled=false" value=""/>n/a::</td><td width="60">&nbsp;</td>
<td>
  <input type="date" name = "divorce_date" value="<?php echo $rows['divorce']; ?>">
</td>
