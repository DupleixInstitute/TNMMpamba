...
$sql1="select count(*) as count,loan_data.industrial_sector as industrial_sector from loan_data,approvals where loan_data.company_reg_no=approvals.company_reg_no and approvals.status='approved' and cast(approvals.date as date)=$year$month$day group by loan_data.industrial_sector";
}

if (isset($day2)) {

$sql1="select count(*) as count,loan_data.industrial_sector as industrial_sector from loan_data,approvals where loan_data.company_reg_no=approvals.company_reg_no and approvals.status='approved' and cast(approvals.date as date)=$year2$month2$day2 group by loan_data.industrial_sector";
}
...
$sql1="select count(*) as count,
	 ...
	 group by loan_data.industrial_sector";
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
   <tr><td><font color="#000066" size="4" class="btn"><strong>INDUSTRIAL SECTOR APPROVALS COUNTS
        ...
        <form name="editform" method="POST">
          <tr><td><p align="justify" class="s_text"><br>
            <table width="300" height="57" border="0" align="center" bordercolor="#000066" bgcolor="#000066"  class="s_text" >
              <tr> 
                  <td width="150" bgcolor="#000066"><strong><font color="#FFFFFF">INDUSTRIAL SECTOR</font></strong></td>
