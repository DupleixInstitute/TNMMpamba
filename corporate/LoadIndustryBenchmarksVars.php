<script>
			 ...
			 localStorage.DebtorDaysBenchmarkComment                    = "<?php echo $DebtorDaysBenchmarkComment?>" ;
			 ...
			 localStorage.TurnoverGrowthBenchmarkComment                = "<?php echo $TurnoverGrowthBenchmarkComment?>" ;
             ...
             localStorage.ROEBenchmarkComment                           = "<?php echo $ROEBenchmarkComment?>" ;
			 ...
			 localStorage.FixedAssetsTurnoverBenchmarkType             = "<?php echo $FixedAssetsTurnoverBenchmarkType?>" ;
             
			 localStorage.FixedAssetsTurnoverGlobalAverage             = "<?php echo $FixedAssetsTurnoverGlobalAverage?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Trade           = "<?php echo $FixedAssetsTurnoverBenchmark_Trade?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Finance         = "<?php echo $FixedAssetsTurnoverBenchmark_Finance?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_RealEstate      = "<?php echo $FixedAssetsTurnoverBenchmark_RealEstate?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Manufacturing   = "<?php echo $FixedAssetsTurnoverBenchmark_Manufacturing?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Construction    = "<?php echo $FixedAssetsTurnoverBenchmark_Construction?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Agriculture     = "<?php echo $FixedAssetsTurnoverBenchmark_Agriculture?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Parastatals     = "<?php echo $FixedAssetsTurnoverBenchmark_Parastatals?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Transport       = "<?php echo $FixedAssetsTurnoverBenchmark_Transport?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_Mining          = "<?php echo $FixedAssetsTurnoverBenchmark_Mining?>" ;
             localStorage.FixedAssetsTurnoverBenchmark_DateUpdated     = "<?php echo $FixedAssetsTurnoverBenchmark_DateUpdated?>" ;
             localStorage.FixedAssetsTurnoverBenchmarkComment          = "<?php echo $FixedAssetsTurnoverBenchmarkComment?>" ;
		  
		     console.log("Finished transferring Industry Benchmarks to Local Storage");
			 alert ("IndustryBenchmarks Settings Loaded");
</script>
