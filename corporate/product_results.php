...
<TITLE>CORPORAT CREDIT SCORING REPORTS - Approvals By Product</TITLE>
...
$sql1="select count(*) as count,loan_data.rate_type_requested as rate from loan_data where cast(creation as date)=$year$month$day group by rate_type_requested;";
}

if (isset($day2)) {

$sql1="select count(*) as count,loan_data.rate_type_requested as rate from loan_data where cast(creation as date)=$year2$month2$day2 group by rate_type_requested;";
}


if(isset($day) && isset($day2))
{
$sql1="select count(*) as count,loan_data.rate_type_requested as rate from loan_data where cast(creation as date) between $year$month$day and $year2$month2$day2 group by rate_type_requested;";

}

if(empty($day) && empty($day2)){ 
$sql1="select count(*) as count,loan_data.rate_type_requested as rate from loan_data group by rate_type_requested;";
}
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
   <tr><td><font color="#000066" size="4" class="btn"><strong>RATE COUNTS
...
&nbsp;&nbsp;<input type="submit" name="submit" class="btn" value="BACK" onclick="form.action='product_report.php'"><br><br>
