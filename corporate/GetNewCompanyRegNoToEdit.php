...
-->
<TITLE>CREDIT SCORING - Get Company Registration Number To Edit</TITLE>
...
<td><img src="assets/images/fdh_logo.png" alt="nknk" name="g" width="385" height="208"/>&nbsp;</td>
<td><font color="#FFFFFF" size="16" face="Arial Narrow"><img src="assets/images/fdh_logo.JPG" alt="nknk" name="g" width="385" height="208"/></font></td>
</table></td>
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CORPORATE CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="GetDataToEdit.php" name="GetRegNo" id = "GetRegNo" method="post" onsubmit = "return Validate()">
