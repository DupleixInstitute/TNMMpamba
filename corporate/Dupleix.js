...
{
	    // Save Date and Username into Industry Analysis Tracker======================================
		...
		localStorage.IndustryAnalysisTrackerDateSaved = date;
		localStorage.IndustryAnalysisTrackerSavedBy = localStorage.username;
...
function ISForm_SaveData()
{
		  ...
		  //1. Net Sales
		   ...
		   //The Non-current assets movement depreciation must be same as IS
		   localStorage.DepreciationCostOfSales0 = 0-ToNumber(localStorage.CosDep0);
		   localStorage.DepreciationCostOfSales1 = 0-ToNumber(localStorage.CosDep1)
		   localStorage.DepreciationCostOfSales2 = 0-ToNumber(localStorage.CosDep2);
		   localStorage.DepreciationCostOfSales3 = 0-ToNumber(localStorage.CosDep3);
		   //3. Cost of Sales - Other
		   ...
		   //Set Non-current assets movement depreciation
		   localStorage.DepreciationOpex0 = 0-ToNumber(localStorage.Depreciation0);
		   localStorage.DepreciationOpex1 = 0-ToNumber(localStorage.Depreciation1);
		   localStorage.DepreciationOpex2 = 0-ToNumber(localStorage.Depreciation2);
		   localStorage.DepreciationOpex3 = 0-ToNumber(localStorage.Depreciation3);
          ...
          //19. Saving the Calculated Items
		   ...
		   //8. Net Profit
	       localStorage.NetProfit0 = ToNumber(document.forms["ISForm"]["NetProfitYear0"].value);
	       localStorage.NetProfit1 = ToNumber(document.forms["ISForm"]["NetProfitYear1"].value);
		   localStorage.NetProfit2 = ToNumber(document.forms["ISForm"]["NetProfitYear2"].value);
		   localStorage.NetProfit3 = ToNumber(document.forms["ISForm"]["NetProfitYear3"].value);
...
function NonCurrentLiabilitiesForm_SaveData()
{
		   ...
		   localStorage.NonCurrentLiabilitiesTrackerDateSaved = date;
		   localStorage.NonCurrentLiabilitiesTrackerSavedBy = localStorage.username;
           //============================================================================================
...
function ProgressTrackerForm_LoadData()
{
   ...
   document.ProgressTrackerForm.BehavioralAnalysisTrackerDateSaved.value =  localStorage.LoanDataTrackerDateSaved;
   document.ProgressTrackerForm.BehavioralAnalysisTrackerSavedBy.value =  localStorage.LoanDataTrackerSavedBy;
   document.ProgressTrackerForm.BehavioralAnalysisTracker1stReviewDate.value =  localStorage.LoanDataTracker1stReviewDate;
   document.ProgressTrackerForm.BehavioralAnalysisTracker1stReviewer.value =  localStorage.LoanDataTracker1stReviewer;
   document.ProgressTrackerForm.BehavioralAnalysisTracker2ndReviewDate.value =  localStorage.LoanDataTracker2ndReviewDate;
   document.ProgressTrackerForm.BehavioralAnalysisTracker2ndReviewer.value =  localStorage.LoanDataTracker2ndReviewer;
   document.ProgressTrackerForm.BehavioralAnalysisTracker1stReviewComment.value =  localStorage.LoanDataTracker1stReviewComment;
   document.ProgressTrackerForm.BehavioralAnalysisTracker2ndReviewComment.value =  localStorage.LoanDataTracker2ndReviewComment;
