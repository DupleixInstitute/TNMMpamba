...
//$username='root';
//$passwd='sefalana2008';
$username= "dinkuk"; //edward $_POST['username'];
//echo  "BBS\ ";
/*$bbs='BBS\\';
...
$user="root";//edwardroot";
$password= "" ; //edward $_POST['password']; // Mysql password 
...
//echo $pass;
  if (!$connect) {
  //edward ($connect); 
  echo "Cannotgghhh connect to the database! Please Check your username and password."; 
}
else {
...
if (!$con)
  ...
  mysqli_select_db($con,"creditscoring" );
?>
...
$query2 = "SELECT * FROM town order by town asc" ;
	$resultn = mysqli_query($con,$query2);
