...
<script>
			  ...
			  localStorage.bfFinancialAnalysis = "<php? echo $bfFinancialAnalysisPercentage; ?>" ;
			  localStorage.bfManagementAnalysis = "<php? echo $bfManagementAnalysisPercentage; ?>" ;
			  localStorage.bfIndustryAnalysis = "<php? echo $bfIndustryAnalysisPercentage; ?>" ;
			  localStorage.bfShareholderAnalysis = "<php? echo $bfShareholderAnalysisPercentage; ?>" ;
			  localStorage.bfBehavioralAnalysis = "<php? echo $bfBehavioralAnalysisPercentage; ?>" ;
		      // Saving Small Firsm Data
			  localStorage.sfFinancialAnalysis = "<php? echo $sfFinancialAnalysisPercentage; ?>" ;
			  localStorage.sfManagementAnalysis = "<php? echo $sfManagementAnalysisPercentage; ?>" ;
			  localStorage.sfIndustryAnalysis = "<php? echo $sfIndustryAnalysisPercentage; ?>" ;
			  localStorage.sfShareholderAnalysis = "<php? echo $sfShareholderAnalysisPercentage; ?>" ;
			  localStorage.sfBehavioralAnalysis = "<php? echo $sfBehavioralAnalysisPercentage; ?>" ;
