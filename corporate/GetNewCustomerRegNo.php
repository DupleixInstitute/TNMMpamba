...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CORPORATE CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
          <td>
        <p></br> 
        <form ACTION="CompanyData.php" name="GetRegNo" method="post">
            <td><table><tr><td><p align="justify" class="s_text"><br>
<table class="s_text">
<tr>
                <td><strong><em><font color="#FF9900" size="1">&nbsp;&nbsp;&nbsp;&nbsp;Enter company's registration number below</font></em></td>
              </tr>
<tr><td>&nbsp;&nbsp;&nbsp;Certificate Of Registratio No :&nbsp;&nbsp;
<input name="CompanyRegistrationNo" type="text" >
</td>
<!----
