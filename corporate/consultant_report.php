...
<TITLE>COPORATE CREDIT SCORING - By Consultant</TITLE>
...
$username="root";$_POST['username']; // Mysql username 
...
<td width="1286" align="CENTER" bgcolor="#000040" class="s_text"><font  color="#FFFFFF" size="7" face="Arial Narrow">CREDIT SCORING</font></td><tr>
   ...
   <table class="s_text" >
        <tr bgcolor="#ECF8FF" class="s_text"> 
         <tr><td>
</td><td><font color="#000066" size="4" class="btn"><strong>&nbsp;&nbsp;CONSULTANT APPROVALS</strong></font></td></tr>
      
<tr><td>&nbsp;&nbsp;&nbsp;</td></tr>



<form action="consultants_approved.php" method="post"> 
...
<tr><td>
</td><td>&nbsp;&nbsp;&nbsp;Date2:&nbsp;&nbsp; <input name="r2" type="checkbox" onclick="day22.disabled=true
year22.disabled=true
month22.disabled=true
" onDblClick="day22.disabled=false
year22.disabled=false
month22.disabled=false" value=""/>n/a:&nbsp;&nbsp;&nbsp;
<?php
